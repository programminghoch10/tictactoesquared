...
hid | text | human readable hexadezimal number for identifing this user on GUI level. intended to be used if several users with the same name exist | unique for this user, never gets changed after creation | NOT NULL
